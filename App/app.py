...
from .AI_Service.app import classifier, explanation_generation, pdf_converter


BASE_DIR = Path(__file__).resolve().parent
PROJECT_ROOT = BASE_DIR.parent
UPLOAD_DIR = PROJECT_ROOT / "accepted_documents"
...
def build_review(text: str, lang: str, model_name: str = OLLAMA_MODEL) -> dict:
    ...
    try:
        explanation = explanation_generation.generate_explanation(
            text,
            lang=lang,
            model=model_name,
            timeout_s=30,
