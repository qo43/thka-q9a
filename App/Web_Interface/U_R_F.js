...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (storedText) {
        ...
        aiTextContainer.textContent = "Ù„Ù… ÙŠØªÙ… Ø§Ù„Ø¹Ø«ÙˆØ± Ø¹Ù„Ù‰ Ù†Øµ. Ø§Ù„Ø±Ø¬Ø§Ø¡ Ø¥Ø¹Ø§Ø¯Ø© Ø§Ù„Ù…Ø­Ø§ÙˆÙ„Ø© Ù…Ù† Ø§Ù„ØµÙØ­Ø© Ø§Ù„Ø±Ø¦ÙŠØ³ÙŠØ©.";
...
btnAccept.addEventListener('click', () => {
    if(confirm("Ù‡Ù„ Ø£Ù†Øª Ù…ØªØ£ÙƒØ¯ Ù…Ù† Ø§Ø¹ØªÙ…Ø§Ø¯ Ø§Ù„Ù†ØªÙŠØ¬Ø©ØŸ")) {
        alert("ØªÙ… Ø§Ù„Ø­ÙØ¸!");
...
function sendMessage() {
    ...
    setTimeout(() => {
        addMessage("Ø¬Ø§Ø±ÙŠ Ø§Ù„Ø¹Ù…Ù„ Ø¹Ù„Ù‰ Ø·Ù„Ø¨Ùƒ... (Ù…Ø­Ø§ÙƒØ§Ø©)", 'ai');
    }, 1000);
}
